...
const curated: KnowledgeRecord[] = [
  ...
  },
  {
    ...
    text: "RP Hope's Stories page includes real accounts from people living with RP, and a way to share your own. On Share Your Story, you can type your story, dictate it by voice, or upload a short video — an AI 'synthesize' step can clean up filler words while preserving your own wording. The recommended length is about 300 to 400 words, though shorter or longer is fine. You choose whether to review the final edited version before it's published, or trust RP Hope to edit and publish it directly. You also choose your display name (or Anonymous) and whether to show contact info. RP Hope follows up within about 10 business days.",
    keywords: ["share your story", "submit my story", "tell my story", "stories", "personal account", "testimonial", "word count", "how long", "story length"],
    contentType: "feature",
    reviewStatus: "reviewed",
  },
];
